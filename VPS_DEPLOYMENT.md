...
sudo systemctl enable kurup-bot kurup-login kurup-sender
sudo systemctl start kurup-bot kurup-login kurup-sender

# Check Status
sudo systemctl status kurup-bot kurup-login kurup-sender
```
